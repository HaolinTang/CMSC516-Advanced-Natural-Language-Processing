...
* **Run in Google Colab:**
   ...
   (Run [IMDB_Sentiment Analysis_LSTM.ipynb](https://colab.research.google.com/drive/1A8Agdp63gJH4KNGwfxVs9wgOcw9wsd0c?usp=sharing))
* **Run in Local Setup:**
    ...
    - Run jupyter from system: `jupyter notebook`. Now, you can run two notebooks in your local system.
